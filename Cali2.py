...
def user_input_features():
  # Entrada
  Horas_de_estudio = st.number_input('Horas de estudio:', min_value=0, max_value=12, value = 0)
  Horas_de_sueño = st.number_input('Horas de sueño:',  min_value=0, max_value=10, value = 0)
  Pocentaje_de_clases_atendidas = st.number_input('Porcentaje de clases atendidas:', min_value=0, max_value=100, value = 0)
  Puntajes_anteriores = st.number_input('Puntajes anteriores:', min_value=0, max_value=100, value = 0)
